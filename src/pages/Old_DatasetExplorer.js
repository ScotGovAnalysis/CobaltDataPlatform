          ...
          case 'csv': {
            ...
            Papa.parse(csvText, {
              ...
              complete: (results) => {
                ...
                // Check if the CSV has 'X' and 'Y' columns
                const hasXYColumns = parsedData.some(row => row.X && row.Y);
                if (hasXYColumns) {
                  // Transform CSV data into GeoJSON format
                  const geoJsonData = {
                  ...
                  setGeoJsonData(geoJsonData); // Set GeoJSON data for MapViewer
                  setHasMap(true); // Enable the map tab
                }
  ...
  return (
    <div className="ds_page__middle">
      <div className="ds_wrapper">
        ...
        <Tabs activeTab={activeTab} setActiveTab={setActiveTab} resourceFormat={resourceFormat} hasMap={hasMap} />
